...
<template>
    <EditorLayout @left-arrow="changeRobe(0)" @right-arrow="changeRobe(1)">
        <template #innerEditorContent>
            ...
            <img v-else :src="robeDisplay" alt="The currently selected Robe" @dragstart.prevent />
        </template>
    </EditorLayout>
    <div class="button-container">
        <div :class="theme.background + ' cursorPointer button'" @click="changeRobe(2)">Toggle Color</div>
    </div>
</template>
